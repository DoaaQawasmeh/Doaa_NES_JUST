...
def FinalAverageInterestRate():
	InterestRateGenerate("bb-2")
	AverageInterestRate("bb-2",0)
	AverageInterestRate("bb-2",1)
	InterestRateGenerate("bb-3")
	AverageInterestRate("bb-3",0)
	AverageInterestRate("bb-3",1)
	InterestRateGenerate("bb-5")
	AverageInterestRate("bb-5",0)
	AverageInterestRate("bb-5",1)
	InterestRateGenerate("gw-3")
	AverageInterestRate("gw-3",0)
	AverageInterestRate("gw-3",1)
