...
def FinalAverageSatisfactionPacketRate():
	SatisfactionPacketRateGenerate("good-leaf-10")
	AverageSatisfactionPacketRate("good-leaf-10",0)
	AverageSatisfactionPacketRate("good-leaf-10",1)
...
def FinalAverageInterestRate():
	InterestRateGenerate("good-leaf-10")
	AverageInterestRate("good-leaf-10",0)
	AverageInterestRate("good-leaf-10",1)
...
def main():
   ...
   AverageSatisfactionRate("good-leaf-10",0)
   AverageSatisfactionRate("good-leaf-10",1)
