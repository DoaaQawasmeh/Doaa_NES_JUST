...
def FinalAverageThroughput():
	ThroughputGenerate("bb-469")
	AverageThroughput("bb-469",0)
	AverageThroughput("bb-469",1)
	ThroughputGenerate("bb-483")
	AverageThroughput("bb-483",0)
	AverageThroughput("bb-483",1)
	ThroughputGenerate("bb-627")
	AverageThroughput("bb-627",0)
	AverageThroughput("bb-627",1)
	ThroughputGenerate("gw-423")
	AverageThroughput("gw-423",0)
	AverageThroughput("gw-423",1)
